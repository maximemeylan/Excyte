...
```{r , fig.width = 8,fig.height=7,dpi=120} 
excyte_plots$heatmap
```
### Umap of event intensities for each channel 
...
```{r , fig.width = 8,fig.height=7,dpi=100} 
grid.arrange(grobs=excyte_plots$ridges[c(9,3,4,1,2,5)],ncol=2)
```
...
rerun_object <- rerun_excyte(excyte_obj = excyte_object,
                             clusters_id = c("c7","c15","c9","c13","c14","c5","c3"), 
                             channels = markers)
